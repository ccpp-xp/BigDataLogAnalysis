...
if __name__ == '__main__':
    ...
    df = df.groupBy("ip").agg(
        countDistinct("url").alias("distinct_urls"),
        countDistinct("request_method").alias("distinct_methods"),
        countDistinct("user_agent").alias("distinct_user_agents"),
